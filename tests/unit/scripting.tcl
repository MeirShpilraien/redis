...
if {$is_eval == 1} {
    ...
    proc run_script {args} {
        r function load LUA test replace [format "redis.register_function('test', function()\n %s \nend)" [lindex $args 0]]
    ...
    proc run_script_on_connection {args} {
        ...
        $rd function load LUA test replace [format "redis.register_function('test', function()\n %s \nend)" [lindex $args 1]]
